 ...
 * 驾车出行路线规划 实现
 */
public class MapRoute extends Activity implements OnMapClickListener,
    ...
    private TextView mresult,mRotueTimeDes, mRouteDetailDes;
    ...
    private void registerListener() {
        aMap.setOnMapClickListener(MapRoute.this);
        aMap.setOnMarkerClickListener(MapRoute.this);
        aMap.setOnInfoWindowClickListener(MapRoute.this);
        aMap.setInfoWindowAdapter(MapRoute.this);
