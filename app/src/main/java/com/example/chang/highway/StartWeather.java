 ...
 * 天气查询 示例查询
 */
public class StartWeather extends Activity implements OnWeatherSearchListener {
    ...
    private String cityname = "大连市";//天气搜索的城市，可以写名称或adcode；

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.f1_weather);
        ...
        city.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent = new Intent(StartWeather.this,weather_citysearch.class);
...
//        String cityname = intent.getStringExtra("scity");
//        init();
        ...
        switch (requestCode){
            case 1:
                if(resultCode == RESULT_OK){
                    cityname = data.getStringExtra("scity");
                    Log.e("11111",cityname);
                    if(cityname != "大连市"){
                    city.setText(cityname);
                    init();
                    searchliveweather();
