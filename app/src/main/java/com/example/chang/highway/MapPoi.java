 ...
 * 介绍poi周边搜索功能
 */
public class MapPoi extends Activity implements OnClickListener,
        OnMapClickListener, OnInfoWindowClickListener, InfoWindowAdapter, OnMarkerClickListener,
        OnPoiSearchListener,GeocodeSearch.OnGeocodeSearchListener {
    ...
    private void init() {
        ...
        //lp = new LatLonPoint(map_lat, 116.472995);
        if (mAMap == null) {
...
//                            "对不起，没有搜索到相关数据！"+addressName,Toast.LENGTH_LONG).show();
                ...
                double Lat = (double)latLongPoint.getLatitude();
                double Lon = (double)latLongPoint.getLongitude();
                //String map_lat = Float.toString(Lat);
                //String map_lon = Float.toString(Lon);
                //latlon.setText(map_lat+","+map_lon);
...
//                break;
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        Toast.makeText(MapPoi.this, infomation, Toast.LENGTH_LONG).show();
