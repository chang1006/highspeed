 ...
 * 沿途搜索 示例
 */
public class MapRoutePoi extends Activity implements OnMapClickListener,
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.map_routepoi);
    ...
    private void registerListener() {
        aMap.setOnMapClickListener(MapRoutePoi.this);
        aMap.setOnMarkerClickListener(MapRoutePoi.this);
        aMap.setOnInfoWindowClickListener(MapRoutePoi.this);
        aMap.setInfoWindowAdapter(MapRoutePoi.this);
